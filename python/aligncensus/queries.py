...
class CensusQuery():
    ...
    def set_census_database_url(self, url, check_url=False):
        """
        ...
        Set `check_url` to True to test that the URL is valid
        """
    ...
    def set_census_variable(self, variable, check_variable=False):
        """
